...
},{"../base/template":"components/base/template.js","../base/webcomponent":"components/base/webcomponent.js"}],"components/ccpa/ccpa.js":[function(require,module,exports) {
"use strict";
 ...
 * @param {WebComponent}
 */
var _CCPATemplate = function _CCPATemplate(context) {
  var options = {};
  return new _template.default(context).setStyle(
  /*css*/
...
/*#__PURE__*/
function (_WebComponent) {
  _inherits(CCPAFooter, _WebComponent);

  _createClass(CCPAFooter, null, [{
    key: "observedAttributes",
  ...
  function CCPAFooter() {
    ...
    _classCallCheck(this, CCPAFooter);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(CCPAFooter).call(this));

    _this.setTemplate(_CCPATemplate(_assertThisInitialized(_this)));
...
_webcomponent.default.addCustomElement('ccpa-footer', CCPAFooter);
},{"../base/template":"components/base/template.js","../base/webcomponent":"components/base/webcomponent.js"}],"index.js":[function(require,module,exports) {
require('./components/dropdown/dropdown');

require('./components/ccpa/ccpa');
},{"./components/dropdown/dropdown":"components/dropdown/dropdown.js","./components/ccpa/ccpa":"components/ccpa/ccpa.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/web-com-test.e31bb0bc.js.map